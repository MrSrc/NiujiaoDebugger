...
public:
	...
	void SetVirtualList(bool bIsVirtual); //niujiao
...
public:
	...
	void ProcessVLScrollbar(RECT rc, DWORD pos);  //niujiao
	void SetVirtualListAttr(bool bIsVirtualList);
    void SetScrollPos(SIZE szPos);
    void SetPos(RECT rc);
    void DoEvent(TEventUI& event);
    BOOL SortItems(PULVCompareFunc pfnCompare, UINT_PTR dwData);
