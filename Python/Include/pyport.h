...
#                       if !defined(__CYGWIN__)
#                               //define PyAPI_FUNC(RTYPE) __declspec(dllimport) RTYPE  niujiao
#                               define PyAPI_FUNC(RTYPE)  RTYPE
#                       endif /* !__CYGWIN__ */
#                      // define PyAPI_DATA(RTYPE) extern __declspec(dllimport) RTYPE niujiao
#                       define PyAPI_DATA(RTYPE) extern  RTYPE
        /* module init functions outside the core must be exported */
#                       if defined(__cplusplus)
#                              // define PyMODINIT_FUNC extern "C" __declspec(dllexport) PyObject*  niujiao
